...
public class DESTest {
    ...
    public void getAlgorithm() {
        System.out.println(Algorithm.getAlgorithm(Algorithm.DES, Mode.CBC, Padding.PKCS7Padding));
        System.out.println(Algorithm.getAlgorithm(Algorithm.DES, Mode.ECB, Padding.NoPadding));
    }

    @Test
    public void generateKey() {
        System.out.println(DESUtils.encrypt(content, key, Mode.ECB, Padding.NoPadding));
        System.out.println(Arrays.toString(DESUtils.generateKey()));
    }
    ...
    public void test() {
        ...
        System.out.println(DESUtils.encrypt(content, key, Mode.ECB, Padding.NoPadding));
        System.out.println(DESUtils.decrypt(DESUtils.encrypt(content, key, Mode.ECB, Padding.NoPadding), key, Mode.ECB, Padding.NoPadding));
        ...
        System.out.println(DESUtils.encrypt(content, key, iv, Mode.CBC, Padding.NoPadding));
        System.out.println(DESUtils.decrypt(DESUtils.encrypt(content, key, iv, Mode.CBC, Padding.NoPadding), key, iv, Mode.CBC, Padding.NoPadding));
