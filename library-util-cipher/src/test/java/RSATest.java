...
import com.dxy.library.util.cipher.constant.SignType;
...
public class RSATest {
    ...
    public void testSign() {
        String sign = RSAUtils.sign(SignType.SHA256withRSA, content, privateKey);
        System.out.println(sign);
        System.out.println(RSAUtils.verifySign(SignType.SHA256withRSA, content, publicKey, sign));
    }
