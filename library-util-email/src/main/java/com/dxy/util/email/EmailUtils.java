...
import com.dxy.util.common.ExecutorUtils;
import com.dxy.util.common.StringUtils;
...
public class EmailUtils {
    private static ExecutorService executorService = ExecutorUtils.getExecutorService("EmailUtils", 3);
